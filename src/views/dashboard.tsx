function Dashboard() {
  return (
    <div className="h-screen flex flex-col ">
      ...
      <div className="ml-5 rounded-lg bg-[#d9d9d9] flex-1 p-5 grid grid-cols-1 sm:grid-cols-1  md:grid-cols-4 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 md:p-5 rounded-lg shadow-md h-32 md:h-auto md:col-span-2"></div>
        <div className="bg-white p-4 md:p-5 rounded-lg shadow-md h-32 md:h-auto md:col-span-2"></div>
