                    ...
                    <fieldset disabled={isSubmitting} className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className={`flex w-full justify-center rounded-md px-4 py-2 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 ${isResendDisabled
